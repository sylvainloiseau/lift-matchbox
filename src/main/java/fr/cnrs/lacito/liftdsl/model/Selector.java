...
public final class Selector {
     ...
     * @param value expected predicate value
     * @return this selector for fluent construction
     */
    public Selector predicate(String name, String language, String value) {
        predicates.put(name + (language == null ? "" : "@" + language), value); return this;
    }

    /**
     * Sets the ordinal selector.
     *
     * @param value one-based sibling index
     * @return this selector for fluent construction
     */
    public Selector index(Integer value) { index = value; return this; }

    /** @return an unmodifiable view of named predicates */
    public Map<String,String> predicates() { return Collections.unmodifiableMap(predicates); }
    ...
    public boolean isEmpty() { return predicates.isEmpty() && index == null; }
     ...
     */
    @Override public String toString() { return index == null ? predicates.toString() : "[index=" + index + "]"; }
}
