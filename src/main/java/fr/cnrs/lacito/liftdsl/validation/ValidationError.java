...
public final class ValidationError extends RuntimeException {
    ...
    public enum Code {
        SYNTAX_ERROR, UNKNOWN_COMPONENT, UNKNOWN_PROPERTY, ILLEGAL_PARENT, MISSING_REQUIRED_PROPERTY,
        DUPLICATE_PROPERTY, ILLEGAL_LANGUAGE, INVALID_SELECTOR, NOT_FOUND, AMBIGUOUS_REFERENCE, PROPERTY_NOT_FOUND,
        UNSET_PROPERTY, INVALID_TARGET
    }
     ...
     */
    public ValidationError(Code code, String message) {
        super(message);
        this.code = code;
    }
